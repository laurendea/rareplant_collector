"""
Django settings for rareplantcollector project.
...
SECRET_KEY = 'django-insecure-c9wrlu2gj#9vgsklv1^@au0c(ofp%ki_elsn&w+^&_4t#k9^et'
...
ROOT_URLCONF = 'rareplantcollector.urls'
...
WSGI_APPLICATION = 'rareplantcollector.wsgi.application'
